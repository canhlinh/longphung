...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__banners_v_version_placement" AS ENUM('home');
  ...
  CREATE TABLE "products" (
  	...
  	"slug" varchar,
  	"category_id" integer,
  	"unit" "enum_products_unit" DEFAULT 'kg',
  ...
  CREATE TABLE "_products_v" (
  	...
  	"version_unit" "enum__products_v_version_unit" DEFAULT 'kg',
  	"version_retail_price" numeric,
  	"version_wholesale_price" numeric,
  	"version_price_label" varchar,
  	"version_stock_status" "enum__products_v_version_stock_status" DEFAULT 'in_stock',
  ...
  CREATE TABLE "banners" (
  	...
  	"link_label" varchar,
  	"link_url" varchar,
  	"placement" "enum_banners_placement" DEFAULT 'home',
  	"is_active" boolean DEFAULT true,
  	"sort_order" numeric DEFAULT 0,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_banners_v" (
  	...
  	"version_placement" "enum__banners_v_version_placement" DEFAULT 'home',
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum__banners_v_version_placement";
